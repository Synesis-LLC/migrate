...
func LinesBeforeAndAfter(data []byte, line, before, after int, lineNumbers bool) []byte {
	// TODO(Synesis-LLC): Trim empty lines at the beginning and at the end
	// TODO(Synesis-LLC): Trim offset whitespace at the beginning of each line, so that indentation is preserved
